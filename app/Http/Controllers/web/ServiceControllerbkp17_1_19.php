...
//        select the samples
        ...
        $reading = DB::table('tbl_samples')->pluck('name', 'id');
...
//                        get volume
                        ...
                        $priceDetail[$pricekey]['volume'] = $getVolume->volume_name;
...
//                        get operation
                        ...
                        $priceDetail[$pricekey]['operation'] = $getOperation->operation_name;

//                        get channel

                        $priceDetail[$pricekey]['channelId'] = $pricevalue->channel;
                        $getChannel = $this->servicePlan->getChannel($priceDetail[$pricekey]['channelId']);
                        $priceDetail[$pricekey]['channel'] = $getChannel->channel_name;

                        //channel point

                        $priceDetail[$pricekey]['pointId'] = $pricevalue->channel_point;
                        $getChaanelPoint = $this->servicePlan->getChannelPoint($priceDetail[$pricekey]['pointId']);
                        if ($getChaanelPoint) {
                            $priceDetail[$pricekey]['channelnumber'] = $getChaanelPoint->channel_number;
                            $priceDetail[$pricekey]['point'] = $getChaanelPoint->point_channel;
                        ...
                        $priceDetail[$pricekey]['channelNumberId'] = $pricevalue->channel_number;


                        $priceDetail[$pricekey]['price'] = $pricevalue->price;
                    }
...
//            die;
        ...
        if ($checkStatus) {
            return view('serviceplan.serviceplanForm')->with('input', $data)->with('priceDetail', $priceDetail)->with('operationSelect', $operationSelect)
                ->with('totalPriceDetails', $totalPriceDetails)->with('title', $title)->with('channelNumbers', $channelNumbers)->with('servicePlanType', $servicePlanType)
