...
class ProductType extends Model
{
    ...
    public function AllProductType($limit = 0, $offset = 0, $order_by = 'tp.product_type_id', $direction = 'ASC', $cond = array(), $count = false, $likeArray = '', $dateField = '', $filter = array())
    {
        $query = DB::table('tbl_product_type as tp');
...
//                    DB::enableQueryLog();
    ...
    public function AllProductTypeGrid($limit = 0, $offset = 0, $order_by = 'tp.product_type_id', $direction = 'ASC', $cond = array(), $count = false, $likeArray = '', $dateField = '', $filter = array())
    {
        $query = DB::table('tbl_product_type as tp');
...
//        print_r($cond);die;
    ...
    public function saveProduct($input)
    {
        ...
        if ($input['product_type_id']) {
            ...
            $result = DB::table('tbl_product_type')->where('product_type_id', $input['product_type_id'])->update($input);
            return $input['product_type_id'];
        } else {
            $input['created_date'] = Carbon::now()->toDateTimeString();

            $result = DB::table('tbl_product_type')->insertGetId($input);
            return $result;
        }
    }
     public function getproduct($Id)
    {
            ...
            $result = DB::table('tbl_product_type')->where('product_type_id', '=', $Id)->first();
