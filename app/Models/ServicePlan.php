...
//            $result = DB::table('tbl_manufacturer')->where('manufacturer_id', $id)->update($input);
    ...
    function getVolumeChange($post)
    {
        $query = DB::table('tbl_service_pricing as tsp');

//        $query->join('tbl_operations as tbo', 'tbo.id', '=', 'tsp.operation');
//        $query->join('tbl_channels as c', 'c.id', '=', 'tsp.channel','left');
//        $query->join('tbl_volume as v', 'v.id', '=', 'tsp.volume','left');
        $query->where([
            ['tsp.id', '=', $post['id']],
//            ['volume', '=', $post['volume']],
//            ['operation', '=', $post['operation']],
//            ['channel', '=', $post['channel']],
//            ['channel_number', '=', $post['channel_number']],
//            ['channel_point', '=', $post['channel_point']],
//            ['price', '=', $post['price']],
        ]);
        return $query->first();
    }
