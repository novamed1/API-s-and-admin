...
class Customertype extends Model
{
    ...
    public function AllCustomer($limit = 0, $offset = 0, $order_by = 'tc.id', $direction = 'ASC', $cond = array(), $count = false, $likeArray = '', $dateField = '', $filter = array())
    {
        $query = DB::table('tbl_customer_type as tc');
...
//
    ...
    public function AllCustomerTypeGrid($limit = 0, $offset = 0, $order_by = 'tc.id', $direction = 'ASC', $cond = array(), $count = false, $likeArray = '', $dateField = '', $filter = array())
    {
        $query = DB::table('tbl_customer_type as tc');
...
//        print_r($cond);die;
    ...
    public function savecustomer($input)
    {
        ...
        if ($input['id']) {
            ...
            $result = DB::table('tbl_customer_type')->where('id', $input['id'])->update($input);
            return $input['id'];
        } else {
            $input['created_date'] = Carbon::now()->toDateTimeString();

            $result = DB::table('tbl_customer_type')->insertGetId($input);
            return $result;
        }
    }
     public function getcustomer($Id)
    {
            ...
            $result = DB::table('tbl_customer_type')->where('id', '=', $Id)->first();
