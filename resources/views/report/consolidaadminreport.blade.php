                ...
                <td valign="top">
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            <td colspan="9">
                                @if($row['spares'])
                                    <p> <span style="font-size: 12px;font-weight: 700;margin-left: 10px;">Maintenance And Spares </span>:  {{$row['spares']}}</p>
                                @endif
                            </td>
                        </tr>
                        <tr>
                            <td colspan="9" style="border-bottom:solid thin #000;">
                                <table cellspacing="0" cellpadding="0" width="100%">
                                    <tr>
                                        <td><span style="font-size: 10px;font-weight: 700;margin-left: 10px;">Calibration Date</span><p style="margin-left: 10px;">{{$row['last_cal_date']}}</p></td>
