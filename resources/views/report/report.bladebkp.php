...
<script type="text/php">
      if (isset($pdf)) {
        ...
        $pdf->page_text(520, 720, "Certificate# {{$certificateNo}}", $font, 7, array(0, 0, 0));
...
<div class="wrapper">
    ...
    <div style="border: solid thin #000;margin-top:5px;padding-bottom: 10px;">
        <table cellspacing="0" cellpadding="0" width="100%" style="page-break-inside: avoid;">
            <tr>
                <td height="60px"
        ...
        <table cellspacing="0" cellpadding="0" width="100%" style="border-top: solid 2px #000;page-break-inside: avoid;">
            <tr>
                ...
                <td width="40%" style="vertical-align:bottom;"><p style="width: 60%;padding:10px 3px 7px;border-bottom:solid thin #000;"><img src="{{asset('users/signature/thumb/'.$uploaded_signature)}}"></p></td>
                <td width="10%" style="padding:2px 5px;font-size:12px;font-weight:700;text-align: right;">Date</td>
                <td width="40%" style="vertical-align:bottom;"><p style="width: 60%;padding:10px 3px 7px;border-bottom:solid thin #000;">{{date('M/d/Y')}}</p></td>
            </tr>
            <?php if($reviewer !='technician') { ?>
            <tr>
                <td width="10%" style="padding:2px 5px;font-size:12px;font-weight:700;text-align: right;">QC Designee</td>
                <td width="40%" style="vertical-align:bottom;"><p style="width: 60%;padding:10px 3px 7px;border-bottom:solid thin #000;"></p></td>
