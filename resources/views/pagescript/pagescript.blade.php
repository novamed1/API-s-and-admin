<script src="{{asset('css/lib/jquery/jquery.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/jquery.nanoscroller/javascripts/jquery.nanoscroller.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/main.js')}}" type="text/javascript"></script>
<script src="{{asset('js/bootstrap/dist/js/bootstrap.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/jquery-flot/jquery.flot.js')}}" type="text/javascript"></script>
<script src="{{asset('js/jquery-flot/jquery.flot.pie.js')}}" type="text/javascript"></script>
<script src="{{asset('js/jquery-flot/jquery.flot.resize.js')}}" type="text/javascript"></script>
...
<script src="{{asset('js/countup/countUp.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/app-dashboard2.js')}}" type="text/javascript"></script>
<script src="{{asset('js/jquery.niftymodals/dist/jquery.niftymodals.js')}}" type="text/javascript"></script>
