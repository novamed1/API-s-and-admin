...
<head>
    ...
    a:link    {color:#01ACF1; text-decoration:underline;}
    a:visited {color:#01ACF1; text-decoration:underline;}
    a:focus   {color:#027EB0 !important;}
    a:hover   {color:#027EB0 !important;}
...
<body style="width:100% !important; color:#333333; background:#fff; font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:1.4;" alink="#9d470a" link="#01ACF1" bgcolor="#fff" text="#333333" yahoo="fix">
  <div id="body_style"> 
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width:100% !important; margin:0; padding:0;">
      <tr bgcolor="#fff">
        <td>
          ...
          <table width="600" cellpadding="0" cellspacing="0" border="0" class="table" style="border: solid 15px #2c4257; box-sizing: border-box; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; -o-box-sizing: border-box;">
                ...
                <table bgcolor="#ffffff" text="#ffffff" width="100%" cellpadding="0" cellspacing="0" border="0">  
                  <tr>
                    ...
                    <td width="280" valign="top" class="hide">
                      ...
                      <a href="javascript:void(0)" style="text-align:right; float: left; margin: 20px 0 0 20px;"><img src="{{asset('img/logo.png')}}" alt="Novamed-logo"/></a>
                    </td>
                    <!-- /header right -->
                  </tr>
                </table>
          ...
          <!-- CONTENT -->
            <!-- set a value for bgcolor -->
            <tr bgcolor="#ffffff">
              <td style="padding:30px 30px 0; width: 400px; box-sizing: border-box; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; -o-box-sizing: border-box;">
                      ...
                      <table bgcolor="#ffffff" width="100%" cellpadding="10" cellspacing="0" border="0">
                        <tr>
                          <td>
                            ...
                            <p style="margin-bottom:.5em; margin: 0 0 10px 0;"><b>Dear {!! $data['name'] !!},</b></p>
                            
                            <p style="margin-bottom:1em; margin: 0 0 10px 0;"></p>
                            
                            <p style="margin-bottom:.5em; margin: 0 0 10px 0;"> {!! $data['message'] !!}  </p>
                        ...
                        <tr>
                          <td colspan="2">                            
                            ...
                            <p style="margin-bottom:.5em; margin: 0 0 15px 0;">
