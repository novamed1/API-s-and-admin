...
@section('content')
    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <h2>Pipette Type List</h2>

            <ol class="breadcrumb">

                <li><a href="#">Home</a></li>
                <li><a href="#">Site Configuration</a></li>
                <li><a href="#">Pipette Type List</a></li>
            ...
            {{--<div class="text-right div-rul">--}}
                {{--<a href="{{url('admin/addpipettetype')}}" class="btn btn-space btn-primary">Create Pipette Type</a>--}}
            {{--</div>--}}
        </div>
        ...
        <script>
            ...
            $('#listTable').DataTable({
                "bServerSide": true,
                "sAjaxSource": "{{url('admin/pipettetypelistdata')}}",
                "sServerMethod": "POST",
                "iDisplayLength": 10,
                "searching": true,
