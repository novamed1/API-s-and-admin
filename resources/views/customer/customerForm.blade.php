                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    {!!Form::text('customerCompanyTitle',$input['customerCompanyTitle'], array('placeholder' => 'Enter the title','class'=>'form-control','id'=>'description')) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    {!!Form::text('customerContactTitlePrefContact','', array('placeholder' => 'Enter the Preferred Contact Title','class'=>'form-control','id'=>'customerContactTitlePrefContact')) !!}
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="m-t-20">
                                        <div class="form-group">
                                            ...
                                            {!!Form::text('customerContactName',$input['customerContactName'], array('placeholder' => 'Enter the Preferred Contact','class'=>'form-control','id'=>'customerContactName','required'=>"")) !!}
                                            <input type="hidden" name="prefer_contact" value="{{$input['prefer_contact']}}" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="m-t-20">
                                        <div class="form-group">
                                            ...
                                            {!!Form::text('customerContactTitlePrefContact',$input['customerContactTitlePrefContact'], array('placeholder' => 'Enter the Preferred Contact Title','class'=>'form-control','id'=>'customerContactTitlePrefContact')) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="m-t-20">
                                        <div class="form-group">
                                            ...
                                            {!!Form::text('customerContactEmail',$input['customerContactEmail'], array('placeholder' => 'Enter the email','data-parsley-type'=>"email",'class'=>'form-control customerContactEmail','id'=>'customerContactEmail','required'=>"")) !!}
                                            <span id="Error_email" style="display: none;color: red" >Email already given in Company Email.Try another one.</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="m-t-20">
                                        <div class="form-group">
                                            ...
                                            {!!Form::text('customerContactTelNo',$input['customerContactTelNo'], array('placeholder' => 'Enter the customer contact number','data-parsley-type'=>"",'class'=>'form-control simple-field-data-mask-selectonfocus','id'=>'customerContactTelNo','data-mask'=>'(000) 000-0000')) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12" id="departmentshow"
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    {!!Form::text('customerBillingContactName',$input['customerBillingContactName'], array('placeholder' => 'Contact Name','class'=>'form-control','id'=>'customerBillingContactName','required'=>"")) !!}
                                </div>
                            </div>
                        </div>
