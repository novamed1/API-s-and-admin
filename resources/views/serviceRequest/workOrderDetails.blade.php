...
@section('content')
    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <h2>Work Order Details (Work Order Number :<span></span> {{$getWorkOrder->work_order_number}})</h2>
            <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
            ...
            <div class="text-right div-rul">
                <a href="{{url('admin/workorderlist')}}" class="btn btn-space btn-primary">Go Back</a>
            </div>
        </div>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <address>
                                                            ...
                                                            <br><span
                                                                    id="changedCustomerCity">{{$customerDetails['getCustomer']->city}}</span><br>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <address>
                                                            ...
                                                            <br><span
                                                                    id="billing_city">{{$customerDetails['getCustomerBilling']->city}}</span><br>
                                                            <abbr title="Phone">Contact: </abbr><span
                                                            ...
                                                            @if($workOrderDetails)
                                                                @foreach($workOrderDetails as $row)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        {{--class="btn btn-space btn-primary"--}}
                                                                        {{--id="changeTechnician"><i class=''--}}
                                                                        {{--aria-hidden="true">Change--}}
                                                                        {{--Technician</i></a>--}}
                                                                        {{--</td>--}}
                    ...
                    <form id="addTech" method="post" data-parsley-validate="" novalidate="">
                        ...
                        <div class="modal-body form" style="padding-top: 10px;">
                            ...
                            <div class="form-group"><br>
                                ...
                                {!!Form::select("maintanenceBy",$technician,$maintanencyBy,array('class'=>'form-control','required'=>'required','id'=>'maintanenceBy'))!!}

                            </div>
                            <div class="form-group">
                                <label>Calibration To</label>
                                {!!Form::select("calibrationBy",$technician,$calibrationBy,array('class'=>'form-control','required'=>'required','id'=>'calibrationBy'))!!}
                            </div>
        ...
        <div id="propertyList" data-toggle="modal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content cuustomercontent">
                    ...
                    <input type="hidden" value="{!! $getWorkOrder->id !!}" id="updateServiceRequestPropertyId">
                    <div class="modal-footer">
