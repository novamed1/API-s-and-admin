                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="m-t-20">
                                            <div class="form-group">
                                                ...
                                                {!!Form::text('description',$input['description'], array( 'placeholder' => 'Enter the capacity','class'=>'form-control','id'=>'capacity','required'=>"required")) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        <section class="col-md-4">
                                            <div class="am-checkbox">
                                                ...
                                                <input id="temp1" type="checkbox" name='temperature' class="needsclick needsclick" value='1' {{$chk}} >
                                        ...
                                        <section class="col-md-4">
                                            <div class="am-checkbox">
                                                ...
                                                @endif
                                                <input id="baro1" type="checkbox" name='barometric_pressure' class="needsclick needsclick" value='1' {{$chk}}>
                                        ...
                                        <section class="col-md-4">
                                            <div class="am-checkbox">
                                                ...
                                                <input id="relative" type="checkbox" name='relative_humidity' class="needsclick needsclick" value='1' {{$chk}} >
                                        ...
                                        <section class="col-md-4">
                                            <div class="am-checkbox">
                                                ...
                                                <input id="check1" type="checkbox" name='accuracy' class="needsclick needsclick" value='1' {{$chk}} >
                                        ...
                                        <section class="col-md-4">
                                            <div class="am-checkbox">
                                                ...
                                                <input id="random" type="checkbox" name='precision' class="needsclick needsclick" value='1' {{$chk}}>
                                ...
                                <div class="am-checkbox" style='margin-left: 62%;'>
                                    ...
                                    <input id="active" type="checkbox" name='is_active' class="needsclick needsclick" value='1' {{$chk}} >
