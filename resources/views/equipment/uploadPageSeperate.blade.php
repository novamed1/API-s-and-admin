    ...
    <div class="am-content gridLayout">
        <div class="page-head">
            ...
            <div class="text-right div-rul">
                <a href="{{url('admin/downloadSampleCsvWithoutDescription')}}" class="btn btn-space btn-primary"><i class="fa fa-download"></i> Download Format</a>
            </div>
            ...
            <div class="row">
                <div class="flash-message">
                    ...
                    <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                        {!! Form::open(array('url' => 'admin/import_parse_withoutdescription', 'class' => 'form','method'=>'post','enctype'=>"multipart/form-data")) !!}
                        {{ csrf_field() }}
                    <div class="col-md-7">
