...
@section('content')
    ...
    <div class="am-content">
        <div class="page-head">
            ...
            @if($data['workorder']->admin_review != '')
        ...
        <div id="verify-alert" class="modal-container modal-full-color modal-effect-8">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{url('admin/qcReview/'.$data['workOrderId'])}}" data-dismiss="modal"
                       class="btn btn-primary btn-shade1 consolidateQc" data-id="{{$data['workOrderId']}}">Yes</a>
                </div>
            </div>
        </div>
