...
@section('content')
    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <div class="text-right div-rul">
                <a href="{{url('admin/isospecification')}}" class="btn btn-space btn-primary">Create ISO Limits</a>
            </div>
        </div>
    ...
    <script>
        ...
        var table = $('#listTable').DataTable( {
            "bServerSide": true,
            "sAjaxSource": "{{url('admin/isospeceficationlistdata')}}",
            "sServerMethod": "POST",
            "iDisplayLength":10,
            "searching": true,
            "columns": [
