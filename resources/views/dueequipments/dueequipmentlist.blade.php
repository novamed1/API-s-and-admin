...
@section('content')
    ...
    <div class="am-content">
        <div class="page-head">
            ...
            {{--<h2 style="text-align: center">Due list from <span id="fromdue">01-Aug-2018</span> to <span id="todue">01-Aug-2018</span></h2>--}}
            <ol class="breadcrumb">
        ...
        <script>
            ...
            var table = $('#listTable').DataTable({
                "bServerSide": true,
                "sAjaxSource": "{{url('admin/duelistdata')}}",
                "sServerMethod": "POST",
                "iDisplayLength": 10,
                "searching": true,
                "processing": true,
            ...
            $('#listTable tfoot th').each(function (index) {
                ...
                if (index == 9) {
                    $(this).html('{!!Form::select("due_status",$due_status,'',array('class'=>'dueStatus','attr'=>'due_status'))!!}');
                }
