    ...
    <div class="am-content">
                        ...
                        <div class="modal-body form">
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="m-t-18">
                                    <div class="form-group">
                                        ...
                                        {!!Form::select("mode",$mode,'',array('class'=>'form-control','required'=>'required','id'=>'mode'))!!}
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="m-t-18">
                                    <div class="form-group">
                                        <label>Amount</label>
                                        {!!Form::text('amount','', array( 'placeholder' => 'Enter the device number','class'=>'form-control','id'=>'payAmount','readonly')) !!}
                                    </div>
                                </div>
                            </div>
                            <div id="extraFields">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="m-t-18">
                                        <div class="form-group">
                                            ...
                                            {!!Form::text('bankname','', array( 'placeholder' => 'Enter Bank Name','class'=>'form-control','id'=>'payBank')) !!}
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="m-t-18">
                                        <div class="form-group">
                                            ...
                                            {!!Form::text('accountno','', array( 'placeholder' => 'Enter Account Number','class'=>'form-control','id'=>'payAccount')) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    <div class="m-t-18">
                                        <div class="form-group">
                                            ...
                                            {!!Form::text('chequeno','', array( 'placeholder' => 'Enter Cheque Number','class'=>'form-control','id'=>'payCheque')) !!}
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            $('#listTable tfoot th').each(function (index) {
                if (index != 9 && index != 7 && index != 8 && index != 6 && index !=5) {
                    var title = $(this).text();
                    $(this).html('<input type="text" placeholder="Search ' + title + '" />');
                }
                if (index == 8) {
                    $(this).html('{!!Form::select("invoice_status",$invoice_status,'',array('class'=>''))!!}');
                }
                if (index == 7) {
                    $(this).html('{!!Form::select("payment_status",$payment_status,'',array('class'=>''))!!}');
                }
                if (index == 6) {
                    $(this).html('{!!Form::select("payment_type",$payment_type,'',array('class'=>''))!!}');
                }
                if (index == 5) {
                    $(this).html('<input type="text" class="datepicker" placeholder="Search Date" />');
                }
                if (index == 0) {
                    $(this).html('{!!Form::select("customer",$customer,'',array('class'=>'','attr'=>'customer'))!!}');
                }
            ...
            $('#listTable').DataTable({
                "bServerSide": true,
                "sAjaxSource": "{{url('admin/orderrequestslistdata')}}",
                "sServerMethod": "POST",
                "iDisplayLength": 10,
                "searching": true,
                "processing": true,
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        ...
                        if (json.result) {
                            ...
                            $('#submitpay').show();
                            $('#loadSpinner').hide();
                            $('#payment_' + order_id).empty();
                            $('#payment_' + order_id).html('<span class="label label-success">{{"Paid"}}</span>');
                            $.toast({
                                heading: 'Success',
