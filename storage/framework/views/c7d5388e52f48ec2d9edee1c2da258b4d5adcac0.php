                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="m-t-20 customerdesign">
                                                ...
                                                <p class="form_text1"><span class="customerSpan">Customer emailId</span>:
                                                    <input
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="m-t-18">
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::select("modelId",$modelname,$input['modelId'],array('class'=>'form-control','id'=>'modelId','placeholder' => 'Enter the model name','required'=>'required')); ?>
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="m-t-20">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::text("pref_tel",$input['pref_tel'],array('class'=>'form-control','placeholder' => 'Enter the telephone','id'=>'pref_tel','required'=>'required')); ?>
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="m-t-18">
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::text('lastDate',$input['lastDate'], array('class'=>'form-control datepicker', 'placeholder' => 'Please choose last date','id'=>'lastdate','required'=>"required")); ?>
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="m-t-20">
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::text('nextDate',$input['nextDate'], array( 'class'=>'form-control datepicker','placeholder' => 'Enter the next due date','id'=>'nextDate','required'=>"required")); ?>
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="m-t-18">
                                            ...
                                            <div class="form-group" id="defaultFreq"
                                                ...
                                                <?php echo Form::select('frequency',$frequency,$input['frequency'], array( 'class'=>'form-control','placeholder' => 'Enter the next due date','id'=>'nextDate','required'=>"required")); ?>
                                            ...
                                            <div class="form-group" id="exactDate"
                                                ...
                                                <?php echo Form::text('freqDate',$input['freqDate'], array( 'class'=>'form-control datepicker','placeholder' => 'Enter the exact date','id'=>'freqDate')); ?>
                                        ...
                                        <div class="m-t-18">
                                            <div class="form-group">
                                                ...
                                                <?php if($servicePlanSelect): ?>
                                                    <?php $__currentLoopData = $servicePlanSelect; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plankey): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                        <?php if($input['planName']== $plankey->id): ?>
                                                        ...
                                                        <div class="am-radio inline">
                                                            <input type="radio" name="planName"
                                                                   class="planName"
                                                                   data-id="<?php echo e($plankey->id); ?>"
                                                                   id="plan_<?php echo e($plankey->id); ?>"
                                                                   value="<?php echo e($plankey->id); ?>"/<?php echo e($planChk); ?>>
                                                            <label for="plan_<?php echo e($plankey->id); ?>"><?php echo e($plankey->service_plan_name); ?></label>
                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <div class="am-checkbox">
                                                                            <input id="radio_<?php echo e($servicerow['servicePriceId']); ?>"
                                                                                   value="<?php echo e($servicerow['servicePriceId']); ?>" type="radio"
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res.result == true) {
                            ...
                            $('#customerTelephone').val(res.data.customer_main_telephone);
