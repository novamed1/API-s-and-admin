    ...
    <div class="am-content gridLayout">
        <div class="page-head">
            ...
            <div class="text-right div-rul">
                ...
                <a href="<?php echo e(url('admin/uploadPage')); ?>" class="btn btn-space btn-primary"><i class="fa fa-upload" aria-hidden="true"></i> Upload Instruments with Model description</a>
                <a href="<?php echo e(url('admin/uploadPageSeperate')); ?>" class="btn btn-space btn-primary"><i class="fa fa-upload" aria-hidden="true"></i> Upload Instruments without Model description</a>
            </div>
        </div>
