<?php $__env->startSection('content'); ?>
    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <h2>Test Point List</h2>

            <ol class="breadcrumb">

                <li><a href="#">Home</a></li>
                <li><a href="#">Site Configuration</a></li>
                <li><a href="#">Test Point</a></li>
            ...
            <div class="text-right div-rul">
                <a href="<?php echo e(url('admin/addtestpoint')); ?>" class="btn btn-space btn-primary">Add Test Point</a>
            </div>
        </div>
        ...
        <script>
            ...
            $('#listTable').DataTable({
                "bServerSide": true,
                "sAjaxSource": "<?php echo e(url('admin/testpointlistdata')); ?>",
                "sServerMethod": "POST",
                "iDisplayLength": 10,
                "searching": true,
