                                ...
                                <div class="campaign-type-frm">
                                    ...
                                    <section class="col-md-2">
                                        ...
                                        <div class="styled-select-lab gender">
                                            ...
                                            <?php echo Form::select('channel_numbers',$channelNumbers,'', array('class'=>'form-control','id'=>'channelnumber')); ?>
                                    ...
                                    <section class="col-md-2">
                                        ...
                                        <div class="styled-select-lab gender">
                                            ...
                                            <?php echo Form::select('points',$channelCrops,'', array('class'=>'form-control','id'=>'pointsPrice')); ?>
                                    ...
                                    <section class="col-md-1">
                                        ...
                                        <div class="styled-select-lab gender">
                                            ...
                                            <?php echo Form::text('Price','', array( 'placeholder' => 'Price','class'=>'form-control pricePrice','id'=>'pricePrice')); ?>
                                                                ...
                                                                <?php if($priceDetail): ?>
                                                                    ...
                                                                    <?php $__currentLoopData = $priceDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pricekey=> $pricerow): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <td> <?php echo e($pricerow['volume']); ?></td>
                                                                            <td> <?php echo e($pricerow['operation']); ?></td>
                                                                            <td> <?php echo e($pricerow['channel']); ?></td>
                                                                            <td> <?php echo e($pricerow['channelnumber']); ?></td>
                                                                            <td> <?php echo e($pricerow['point']); ?></td>
                                                                            <td> <?php echo e($pricerow['price']); ?></td>
