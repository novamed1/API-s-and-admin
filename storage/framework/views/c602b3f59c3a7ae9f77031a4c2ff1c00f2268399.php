        ...
        <tr>
            ...
            <td style="text-align: left;vertical-align: top;">
                <p style="font-size: 11px;color:#000;margin: 0;padding: 0 0 2px;"><span
                            style="color:#999;display: inline-block;width: 120px;">Quotation date:</span> <?php echo e(date('m-d-Y')); ?>

                </p>
                <p style="font-size: 11px;color:#000;margin: 0;padding: 0 0 2px;"><span
                            style="color:#999;display: inline-block;width: 120px;">Quotation#:</span> <?php echo e($qutationnumber); ?>
        ...
        <tr>
            <td style="border-right: solid thin #ddd;">
                <h5 style="font-size: 14px;color:#666;text-align:center;text-transform: uppercase;text-align:center;margin: 0;padding: 5px 0;font-weight: 400;">
                    Customer Name</h5>
                <h3 style="font-size: 13px;color:#000;text-align:center;text-transform: uppercase;text-align:center;margin: 0;padding: 0px 0;font-weight: 700;"><?php echo e($data['customer']->customer_name); ?></h3>
            </td>
            <td style="border-right: solid thin #ddd;">
                <h5 style="font-size: 14px;color:#666;text-align:center;text-transform: uppercase;text-align:center;margin: 0;padding: 5px 0;font-weight: 400;">
                    State</h5>
                <h3 style="font-size: 13px;color:#000;text-align:center;text-transform: uppercase;text-align:center;margin: 0;padding: 0px 0;font-weight: 700;"><?php echo e($data['customer']->state); ?></h3>
            </td>
            <td style="border-right: solid thin #ddd;">
                <h5 style="font-size: 14px;color:#666;text-align:center;text-transform: uppercase;text-align:center;margin: 0;padding: 5px 0;font-weight: 400;">
                    City</h5>
                <h3 style="font-size: 13px;color:#000;text-align:center;text-transform: uppercase;text-align:center;margin: 0;padding: 0px 0;font-weight: 700;">
                    <?php echo e($data['customer']->city); ?></h3>
            </td>
            <td>
                <h5 style="font-size: 14px;color:#666;text-align:center;text-transform: uppercase;text-align:center;margin: 0;padding: 5px 0;font-weight: 400;">
                    Zip code</h5>
                <h3 style="font-size: 13px;color:#000;text-align:center;text-transform: uppercase;text-align:center;margin: 0;padding: 0px 0;font-weight: 700;"><?php echo e($data['customer']->zip_code); ?></h3>
            </td>
        </tr>
            ...
            <?php if(count($items)): ?>
                ...
                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <tr style="border-bottom: solid thin #ddd;">
                        ...
                        <td style="font-size:12px;color:#000;padding:3px;border-right:solid thin #ddd;vertical-align: top;"><?php echo e($row['description']); ?></td>
                        ...
                        <td style="font-size:12px;color:#000;padding:3px;border-right:solid thin #ddd;vertical-align: top;">
                            $ <?php echo e($row['totalItemPrice']); ?></td>

                    </tr>

                    <?php if(count($row['lineItems'])): ?>
                            <tr style="border-bottom: solid 0px #ddd;background: #eceaea;">
                                ...
                                <td colspan="5"
                                    ...
                                    Assets for Above Item
                                </td>
                            </tr>
                        <?php $j=1 ?>
                        <?php $__currentLoopData = $row['lineItems']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $srow): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <tr style="border-bottom: solid 0px #ddd;background: #eceaea;">
                                ...
                                <td style="font-size:10px;color:#000;padding:3px;border-right:solid thin #ddd;vertical-align: top;">
                                    <?php echo e($srow['asset_no']); ?>

                                </td>
                                <td style="font-size:10px;color:#000;padding:3px;border-right:solid thin #ddd;vertical-align: top;">
                                    <?php echo e($srow['serial_no']); ?>

                                </td>
                                <td style="font-size:10px;color:#000;padding:3px;border-right:solid thin #ddd;vertical-align: top;">
                                    <?php echo e($srow['frequency']); ?>

                                </td>
                                <td style="font-size:10px;color:#000;padding:3px;border-right:solid thin #ddd;vertical-align: top;">
                                    <?php echo e($srow['plan']); ?>

                                </td>

                                <td style="font-size:10px;color:#000;padding:3px;border-right:solid thin #ddd;vertical-align: top;">
                                    $ <?php echo e(number_format($srow['price'],2)); ?>
