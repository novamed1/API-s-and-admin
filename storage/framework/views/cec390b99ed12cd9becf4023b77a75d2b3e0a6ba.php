<?php $__env->startSection('content'); ?>
    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <h2>Service Plan Type List</h2>

            <ol class="breadcrumb">

                <li><a href="#">Home</a></li>
                <li><a href="#">Master Setup</a></li>
                <li><a href="#">Service Plan Type</a></li>
            ...
            <div class="text-right div-rul">
                <a href="<?php echo e(url('admin/addcustomertype')); ?>" class="btn btn-space btn-primary">Create Service Plan Type</a>
            </div>
        </div>
        ...
        <script>
            ...
            $('#listTable').DataTable({
                "bServerSide": true,
                "sAjaxSource": "<?php echo e(url('admin/customertypelistdata')); ?>",
                "sServerMethod": "POST",
                "iDisplayLength": 10,
                "searching": true,
