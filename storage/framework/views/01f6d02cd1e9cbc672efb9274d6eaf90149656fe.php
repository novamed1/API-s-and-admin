...
<?php $__env->startSection('content'); ?>
    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <div class="text-right div-rul">
                <a href="<?php echo e(url('admin/addchannelpoints')); ?>" class="btn btn-space btn-primary">Create Channel Points</a>
            </div>
        </div>
    ...
    <script src="<?php echo e(asset('js/jquery-confirm.js')); ?>"></script>
        ...
        <script>
            ...
            $('#listTable').DataTable({
                "bServerSide": true,
                "sAjaxSource": "<?php echo e(url('admin/channelpointslistdata')); ?>",
                "sServerMethod": "POST",
                "iDisplayLength": 10,
                "searching": true,
