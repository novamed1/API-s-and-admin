                                            ...
                                            <div class="m-t-18">
                                                ...
                                                <div class="row div-cl-row">
                                                    <section class="col-md-4" id='valueform'>
                                                        ...
                                                        <?php echo Form::text('volume_from',$input['volume_from'], array('data-parsley-type'=>"number",'class'=>'form-control volume_from','required'=>"")); ?>
                                                    ...
                                                    <?php if(($input['id'] && $input['volume']) || !$input['id']): ?>
                                                        ...
                                                        <section class="col-md-4" id='valueto'>
                                                            ...
                                                            <?php echo Form::text('volume_to',$input['volume_to'], array('data-parsley-type'=>"number",'class'=>'form-control volume_to fromvalue')); ?>
