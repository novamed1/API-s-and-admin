    ...
    <div class="am-content gridLayout">
        <div class="page-head">
            ...
            <div class="text-right div-rul">
                <a href="<?php echo e(url('admin/downloadSampleCsv')); ?>" class="btn btn-space btn-primary"><i class="fa fa-download"></i> Download Format</a>
            </div>
            ...
            <div class="row">
                <div class="flash-message">
                    ...
                    <input type="hidden" name="_token" id="token" value="<?php echo e(csrf_token()); ?>">
                        <?php echo Form::open(array('url' => 'admin/import_parse', 'class' => 'form','method'=>'post','enctype'=>"multipart/form-data")); ?>
