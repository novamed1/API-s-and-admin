        ...
        <tr>
            <td style="border-right: solid thin #ddd;">
                <h5 style="font-size: 14px;color:#666;text-align:center;text-transform: uppercase;text-align:center;margin: 0;padding: 5px 0;font-weight: 400;">
                    Customer Name</h5>
                <h3 style="font-size: 13px;color:#000;text-align:center;text-transform: uppercase;text-align:center;margin: 0;padding: 0px 0;font-weight: 700;"><?php echo e((isset($data['purchase']->unique_id)&&$data['purchase']->unique_id)?$data['purchase']->unique_id:''); ?></h3>
            </td>
            <td style="border-right: solid thin #ddd;">
                <h5 style="font-size: 14px;color:#666;text-align:center;text-transform: uppercase;text-align:center;margin: 0;padding: 5px 0;font-weight: 400;">
                    Customer Name</h5>
            ...
            <td >
                ...
                <h3 style="font-size: 13px;color:#000;text-align:center;text-transform: capitalize;text-align:center;margin: 0;padding: 0px 0;font-weight: 700;"><?php echo e((isset($orderItems) && $orderItems) ?  count($orderItems) : ''); ?>
            ...
            <?php if(count($orderItems)): ?>
                ...
                <?php $__currentLoopData = $orderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <tr style="border-bottom: solid thin #ddd;">
                        ...
                        <td style="font-family: 'DejaVu Sans';font-size:12px;color:#000;padding:3px;border-right:solid thin #ddd;vertical-align: top;"><?php echo e($row->name); ?></td>
