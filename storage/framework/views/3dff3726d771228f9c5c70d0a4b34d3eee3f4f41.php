                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="m-t-18">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php echo Form::text("modelSku",$input['modelSku'],array('class'=>'form-control modelSku','id'=>'modelSku')); ?>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                ...
                                                <button data-wizard="#wizard1"
                                                        ...
                                                        data-url="<?php echo e(url('admin/checkModelCombination')); ?>"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <section class="col-md-1">
                                                        ...
                                                        <div class="styled-select-lab gender">
                                                            ...
                                                            <?php echo Form::text('servicePrice','', array( 'placeholder' => '','class'=>'form-control sparesPrice','id'=>'servicePrice')); ?>
                                                                                ...
                                                                                <?php if($spares): ?>
                                                                                    ...
                                                                                    <?php $__currentLoopData = $spares; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sparekey=> $sparerow): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                                        ...
                                                                                        <tr class="div-lits"
                                                                                            ...
                                                                                            <td> <?php echo e($sparerow['servicePrice']); ?></td>
                                                                                            <td> <?php echo e($sparerow['image']); ?></td>
                                                                                            <td>
                                                                                                <?php if($sparerow['part_buy'] == 1): ?>
                                                                                                    Yes
                                                                                                <?php else: ?>
                                                                                                    No
                                                                                                <?php endif; ?>
                                                                                            ...
                                                                                            <?php echo Form::hidden("sparedetail[".$i."][servicePrice]",$sparerow['servicePrice'],array('class'=>'form-control','id'=>'spare'.'-'.$i)); ?>
                                                                                            ...
                                                                                            <?php echo Form::hidden("sparedetail[".$i."][sell]",$sparerow['part_sell'],array('class'=>'form-control','id'=>'spare'.'-'.$i)); ?>
    ...
    <script>
        $('body').on('mouseover', '.next-step', function () {
            ...
            if(volumetype == 'Variable'){
                ...
                $.ajax({
                    type: 'post',
                    url: "<?php echo e(url("admin/checkModelCombination")); ?>",
                    data: {
