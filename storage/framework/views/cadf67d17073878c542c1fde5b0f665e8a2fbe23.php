    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">Technicians List</a></li>

                <!--                    <li class="active"></li>-->

            </ol>
            <div class="text-right div-rul">
                <a href="<?php echo e(url('admin/addtechnician')); ?>" class="btn btn-space btn-primary">Create new technician</a>
            </div>
        </div>
        ...
        <script>
            ...
            $('#listTable').DataTable( {
                "bServerSide": true,
                "sAjaxSource": "<?php echo e(url('admin/technicianlistdata')); ?>",
                "sServerMethod": "POST",
                "iDisplayLength":10,
                "searching": true,
