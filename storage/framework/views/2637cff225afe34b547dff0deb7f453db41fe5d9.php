<?php $__env->startSection('content'); ?>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <address>
                                                            ...
                                                            <br><span
                                                                    id="changedCustomerzipcode"><?php echo e($customerinfo['getCustomer']->zip_code); ?></span><br>
                                                        ...
                                                        <address><strong>Email Id
                                                                <?php if($customerinfo['access'] == 0): ?>
                                                                    <img src="<?php echo e(asset('img/verify2.png')); ?>"
                                                                         title="Email Verified">
                                                                <?php else: ?>
                                                                    <img src="<?php echo e(asset('img/failure.png')); ?>"
                                                                         title="Email Not Verified">
                                                                <?php endif; ?>
                                                                <br></strong><a
                                                                    mailto:#><span
                                                                        id="changedCustomerEmail"><?php echo e($customerinfo['getCustomer']->customer_email); ?>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <address>
                                                            ...
                                                            <br><?php echo e((isset($customerinfo['payment']->pay_terms)&&$customerinfo['payment']->pay_terms)?$customerinfo['payment']->pay_terms:''); ?>

                                                            <?php if(isset($customerinfo['payment']->pay_method)&&$customerinfo['payment']->pay_method): ?>
                                                                                        ...
                                                                                        <?php for($i=0;$i<$total_equipments;$i++): ?>
                                                                                            ...
                                                                                            <tr class="viewDetail">
                                                                                                ...
                                                                                                <td>
                                                                                                    <input
                                                                                                            type="text"
                                                                                                            class="form-control serviceList lastdatepicker lastCalDateVal_<?php echo e($i); ?>"
                                                                                                            data-unique=<?php echo e($i); ?> data-id=<?php echo e($row["buy_service_model_id"]); ?>
                                                                                                    ...
                                                                                                    <input
                                                                                                            ...
                                                                                                            data-unique=<?php echo e($i); ?> data-id=<?php echo e($row["buy_service_model_id"]); ?>
                                                                                                                    ...
                                                                                                                    id="LastCaldate-<?php echo e($row["buy_service_model_id"]); ?>-<?php echo e($i); ?>"
                                                                                                            name="model[<?php echo e($row["buy_service_model_id"]); ?>][<?php echo e($i); ?>][lastcaldate]"
                                                                                                ...
                                                                                                <td>
                                                                                                    ...
                                                                                                    <?php echo Form::select("model[".$row['buy_service_model_id']."][".$i."][frequency]",$frequency,$row['frequency'],array('class'=>'changeFrequency serviceList serviceListdropdown frequencyOption_'.$i.' form-control','data-id'=>$row['buy_service_model_id'],'data-val'=>$i,'id'=>'frequencyOption_'.$row['buy_service_model_id'])); ?>
    ...
    margin-top: 3px;">
                                                                                                            ...
                                                                                                            <input
                                                                                                                    ...
                                                                                                                    data-id="<?php echo e($row['buy_service_model_id']); ?>"
                                                                                                                    data-val="<?php echo e($i); ?>"
                                                                                                    ...
                                                                                                    <input
                                                                                                            ...
                                                                                                            data-id="<?php echo e($row['buy_service_model_id']); ?>"
                                                                                                            data-val="<?php echo e($i); ?>"
                                                                                                            id="intervalperiod-<?php echo e($row["buy_service_model_id"]); ?>-<?php echo e($i); ?>"
                                                                                                            name="model[<?php echo e($row["buy_service_model_id"]); ?>][<?php echo e($i); ?>][intervalperiod]">
                                                                                                </td>
                                                                                                ...
                                                                                                <td class="nextDueTextDate-<?php echo e($row["buy_service_model_id"]); ?>-<?php echo e($i); ?>">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                           ...
                                                                                                           readonly
                                                                                                           class="form-control serviceList calByDate_<?php echo e($i); ?> nextDue-<?php echo e($row["buy_service_model_id"]); ?>-<?php echo e($i); ?>"
                                    ...
                                    <table align="right">
                                        <tr>
                                            ...
                                            <td style="width: 170px"><input type="text" name="sub-total" id="sub-total"
                                                                            ...
                                                                            class="form-control"
                                                                            value="<?php echo e($sub_total); ?>" readonly></td>
                                        </tr>
                                        <tr>
