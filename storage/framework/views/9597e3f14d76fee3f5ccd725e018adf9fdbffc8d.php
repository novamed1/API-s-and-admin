    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <div class="text-right div-rul">
                <a href="<?php echo e(url('admin/addmanufacturer')); ?>" class="btn btn-space btn-primary">Create Manufacturer</a>
            </div>
        </div>
        ...
        <script>
            ...
            $('#listTable').DataTable({
                "bServerSide": true,
                "sAjaxSource": "<?php echo e(url('admin/manufacturerlistdata')); ?>",
                "sServerMethod": "POST",
                "iDisplayLength": 10,
                "searching": true,
