                ...
                <div class="col-lg-12" style="">
                    ...
                    <div class="col-lg-6" style="border-right: 1px solid #eee;;">
                        ...
                        <div class="form-group" style="margin-top: 134px;">
                            ...
                            <?php echo Form::textarea('paymentTerms',isset($customer_setups['payTerms'])?$customer_setups['payTerms']:'', array('class'=>'form-control','id'=>'paymentTerms','cols'=>30,'rows'=>'5','required'=>"")); ?>
                ...
                <div class="col-lg-12" style="margin-bottom: 30px;">
                    ...
                    <div class="col-lg-6" style="border-right: 1px solid #eee;;">
                        ...
                        if($customer_setups)
                        {
                            ...
                            {
                                $exact_date = date('m-d-Y',strtotime(str_replace('/','-',$customer_setups['excatDate'])));
                            }
                        }
                        else
                            {
                        ...
                        <div class="form-group" style="margin-top:106px;">
                            ...
                            <?php echo Form::text('exactDate',$exact_date, array('class'=>'form-control datepicker','id'=>'exactDate')); ?>
                ...
                <div class="col-lg-12" style="">
                    ...
                    <div class="col-lg-6" style="border-right: 1px solid #eee;;">
                        ...
                        <div class="form-group" style="margin-bottom: 30px;margin-top: 109px;">
                            ...
                            <?php echo Form::textarea('shippingComment',isset($customer_setups['shippingComments'])?$customer_setups['shippingComments']:"", array( 'placeholder' => 'Enter the Comment','class'=>'form-control','id'=>'shippingComment','rows'=>'5','required'=>"")); ?>
    ...
    <script>
        ...
        $('body').on('click', '#customerSetupSubmission', function () {
            ...
            $.ajax({
                ...
                type: "POST",
                data: data,
                url: "<?php echo e(url("admin/addCustomerSetup")); ?>",
                dataType: "JSON",
                success: function (json) {
                    if (json.result) {
                        $('#submitForm').trigger('click');
                        //window.location = "<?php echo e(url("admin/customerSetup")); ?>";
                    }
                }
            });
        });
