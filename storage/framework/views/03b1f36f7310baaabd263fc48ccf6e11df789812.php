    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">Channel Numbers</a></li>
            ...
            <div class="text-right div-rul">
                <a href="<?php echo e(url('admin/addchannelnumbers')); ?>" class="btn btn-space btn-primary">Create Channel Number</a>
            </div>
        </div>
        ...
        <script>
            ...
            $('#listTable').DataTable({
                "bServerSide": true,
                "sAjaxSource": "<?php echo e(url('admin/channelnumberslistdata')); ?>",
                "sServerMethod": "POST",
                "iDisplayLength": 10,
                "searching": true,
