    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">Standard Equipment</a></li>
            ...
            <div class="text-right div-rul">
                <a href="<?php echo e(url('admin/adddevicemodel')); ?>" class="btn btn-space btn-primary">Create Standard Equipment</a>
            </div>
        </div>
        ...
        <script>
            ...
            $('#listTable').DataTable({
                "bServerSide": true,
                "sAjaxSource": "<?php echo e(url('admin/devicemodellistdata')); ?>",
                "sServerMethod": "POST",
                "iDisplayLength": 10,
                "searching": true,
