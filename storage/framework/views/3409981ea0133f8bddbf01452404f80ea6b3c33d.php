                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerCompanyZipCode',$input['customerCompanyZipCode'], array('placeholder' => 'Enter the zip code','class'=>'form-control','id'=>'customerCompanyZipCode','data-geocomplete'=>'zipcode','maxlength'=>'5')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerCompanyTelNo',$input['customerCompanyTelNo'], array('placeholder' => 'Enter the telephone','data-parsley-type'=>"",'class'=>'form-control simple-field-data-mask-selectonfocus','id'=>'customerCompanyTelNo','data-mask'=>'(000) 000-0000')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerCompanyMainTelNo',$input['customerCompanyMainTelNo'], array('placeholder' => 'Enter the telephone number','data-parsley-type'=>"",'class'=>'form-control simple-field-data-mask-selectonfocus','id'=>'description','data-mask'=>'(000) 000-0000')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerCompanyMainFaxNo',$input['customerCompanyMainFaxNo'], array('placeholder' => 'Enter the company fax number','data-parsley-type'=>"",'class'=>'form-control simple-field-data-mask-selectonfocus','id'=>'customerCompanyMainFaxNo','data-mask'=>'(000) 000-0000')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerCompanyTitle',$input['customerCompanyTitle'], array('placeholder' => 'Enter the title','class'=>'form-control','id'=>'description')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerCompanyEmail',$input['customerCompanyEmail'], array('placeholder' => 'Enter the company email','data-parsley-type'=>"email",'class'=>'form-control','id'=>'customerCompanyEmail','required'=>"")); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerContactName','', array('placeholder' => 'Enter the Preferred Contact','class'=>'form-control','id'=>'customerContactName','required'=>"")); ?>

                               <input type="hidden" name="prefer_contact" value="<?php echo e($input['prefer_contact']); ?>" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerContactTitlePrefContact','', array('placeholder' => 'Enter the Preferred Contact Title','class'=>'form-control','id'=>'customerContactTitlePrefContact')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerContactEmail','', array('placeholder' => 'Enter the email','data-parsley-type'=>"email",'class'=>'form-control customerContactEmail','id'=>'customerContactEmail','required'=>"")); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerContactTelNo','', array('placeholder' => 'Enter the customer contact number','data-parsley-type'=>"",'class'=>'form-control simple-field-data-mask-selectonfocus','id'=>'customerContactTelNo','data-mask'=>'(000) 000-0000')); ?>

                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-12" id="departmentshow"
                             style="<?php echo e((($input['customerCompanyType'] =="2" && $input['id'] !=''))? '':'display:none'); ?>">
                            <div class="m-t-20">
                                <div class="form-group">
                                    <label>Department</label>

                                    <?php echo Form::text('customerDepartment','', array('placeholder' => 'Enter the department','class'=>'form-control','id'=>'customerDepartment')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12" id="buildingshow"
                            ...
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerContactBuildingName','', array('placeholder' => 'Enter the building name','class'=>'form-control','id'=>'customerContactBuildingName')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12" id="roomshow"
                            ...
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerContactRoomNo','', array('placeholder' => 'Enter the room number','class'=>'form-control','id'=>'customerContactRoomNo')); ?>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="m-t-20">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::text('customerContactTitlePrefContact',$input['customerContactTitlePrefContact'], array('placeholder' => 'Enter the Preferred Contact Title','class'=>'form-control','id'=>'customerContactTitlePrefContact')); ?>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="m-t-20">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::text('customerContactEmail',$input['customerContactEmail'], array('placeholder' => 'Enter the email','data-parsley-type'=>"email",'class'=>'form-control customerContactEmail','id'=>'customerContactEmail','required'=>"")); ?>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="m-t-20">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::text('customerContactTelNo',$input['customerContactTelNo'], array('placeholder' => 'Enter the customer contact number','data-parsley-type'=>"",'class'=>'form-control simple-field-data-mask-selectonfocus','id'=>'customerContactTelNo','data-mask'=>'(000) 000-0000')); ?>
                                ...
                                <div class="col-sm-6 col-xs-12" id="buildingshow"
                                    ...
                                    <div class="m-t-20">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::text('customerContactBuildingName',$input['customerContactBuildingName'], array('placeholder' => 'Enter the building name','class'=>'form-control','id'=>'customerContactBuildingName')); ?>
                                ...
                                <div class="col-sm-6 col-xs-12" id="roomshow"
                                    ...
                                    <div class="m-t-20">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::text('customerContactRoomNo',$input['customerContactRoomNo'], array('placeholder' => 'Enter the room number','class'=>'form-control','id'=>'customerContactRoomNo')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerBillingContactName',$input['customerBillingContactName'], array('placeholder' => 'Contact Name','class'=>'form-control','id'=>'customerBillingContactName','required'=>"")); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerBillingEmail',$input['customerBillingEmail'], array('placeholder' => 'Enter the Email','data-parsley-type'=>"email",'class'=>'form-control','id'=>'customerBillingEmail','required'=>"")); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerBillingZipCode',$input['customerBillingZipCode'], array('placeholder' => 'Enter the Zip Code','class'=>'form-control','id'=>'customerBillingZipCode','required'=>"",'data-geocomplete'=>'zipcode','maxlength'=>'5')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerBillingTelNo',$input['customerBillingTelNo'], array('placeholder' => 'Enter the Tel#','data-parsley-type'=>"",'class'=>'form-control simple-field-data-mask-selectonfocus','id'=>'customerBillingTelNo','data-mask'=>'(000) 000-0000')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerBillingFaxNo',$input['customerBillingFaxNo'], array('placeholder' => 'Enter the Fax#','data-parsley-type'=>"",'class'=>'form-control simple-field-data-mask-selectonfocus','id'=>'customerBillingFaxNo','data-mask'=>'(000) 000-0000')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12" id="billingMailCode"
                            ...
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('BillingMailCode',$input['BillingMailCode'], array('placeholder' => 'Enter the Mail Code','class'=>'form-control','id'=>'billingMailCode')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12" id="billingdeptshow"
                            ...
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerBillingDepartment',$input['customerBillingDepartment'], array('placeholder' => 'Enter the Department','class'=>'form-control','id'=>'customerBillingDept')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12" id="billingbuildingshow"
                            ...
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerBillingDepartmentBuilding',$input['customerBillingDepartmentBuilding'], array('placeholder' => 'Enter the Building Name','class'=>'form-control','id'=>'customerBillingBuilding')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12" id="billingroomshow"
                            ...
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerBillingRoom',$input['customerBillingRoom'], array('placeholder' => 'Enter the Room Number','class'=>'form-control','id'=>'customerBillingRoom')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerShippingEmail',$input['customerShippingEmail'], array('placeholder' => 'Enter the Email','data-parsley-type'=>"email",'class'=>'form-control','id'=>'customerShippingEmail','required'=>"")); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerShippingZipCode',$input['customerShippingZipCode'], array('placeholder' => 'Enter the Zip Code','class'=>'form-control','id'=>'customerShippingZipCode','required'=>"",'data-geocomplete'=>"zipcode",'maxlength'=>'5')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerShippingTelNo',$input['customerShippingTelNo'], array('placeholder' => 'Enter the Tel#','data-parsley-type'=>"",'class'=>'form-control simple-field-data-mask-selectonfocus','id'=>'customerShippingTelNo','data-mask'=>'(000) 000-0000')); ?>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="m-t-20">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('customerShippingFaxNo',$input['customerShippingFaxNo'], array('placeholder' => 'Enter the Fax#','data-parsley-type'=>"",'class'=>'form-control simple-field-data-mask-selectonfocus','id'=>'customerShippingFaxNo','data-mask'=>'(000) 000-0000')); ?>
