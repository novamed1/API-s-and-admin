                    ...
                    <div class="error">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <?php if(($input['id'])): ?>
                                    <?php echo Form::model($input, array('url' => 'admin/editdevice/'.$input['id'], 'files' => true)); ?>
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="m-t-18">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" value="<?php echo $input['id']; ?>" name="id" id="ID">
                                                <?php echo Form::select("devicemodelId",$devicemodel,$input['devicemodelId'],array('class'=>'form-control','id'=>'devicemodel','required'=>"required",'placeholder'=>'Please choose device model')); ?>
                                            ...
                                            <div class="form-group sensitivityform"  style="<?php echo e($input['devicemodelId'] =="1" ? '':'display:none'); ?>">
                                                ...
                                                <?php echo Form::select("sensitivity",$sensitivity,$input['sensitivity'],array('class'=>'form-control','id'=>'sensitivity','required'=>"required",'placeholder'=>'Please choose sensitivity')); ?>
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="m-t-20">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::select("frequencyId",$frequency,$input['frequencyId'],array('class'=>'form-control','id'=>'frequency','required'=>'required','placeholder'=>'Please choose frequency')); ?>
    ...
    <script>
        ...
        $('body').on('click', '#devicesubmit', function (event) {
            ...
            var id = $('#ID').val();
                ...
                $.ajax({
                    type: 'post',
                    url: "<?php echo e(url("admin/checkSerialNumber")); ?>",
                    data: {
                        serialno:description,id:id,"_token": "<?php echo csrf_token(); ?>"
                    },
                    dataType: "json",
