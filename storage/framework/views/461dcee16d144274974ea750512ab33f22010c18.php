                        ...
                        <div class="panel-body">
                            ...
                            <div class="row div-cl-row">
                                <section class="col-md-4" id='valueform'>
                                    ...
                                    <?php echo Form::text('volume_from',$input['volume_value_from'], array('data-parsley-type'=>"number",'class'=>'form-control volume_from','required'=>"",'id'=>'volumeFrom','onkeypress'=>'return isNumberKey(event,this)')); ?>
                                ...
                                <?php if((($input['id'] && $input['volume_value_to']))): ?>
                                    ...
                                    <section class="col-md-4" id='valueto'>
                                        ...
                                        <?php echo Form::text('volume_to',$input['volume_value_to'], array('data-parsley-type'=>"number",'class'=>'form-control volume_to fromvalue','id'=>'volumeToRange','onkeypress'=>'return isNumberKey(event,this)')); ?>
                            ...
                            <div class="campaign-type-frm">
                                <div class="row">
                                    ...
                                    <section class="col-md-2">
                                        ...
                                        <?php echo Form::text('toleranceArray['.$tpkey.'][accuracy]',(isset($input['tolerances'][$tpkey])&&$input['tolerances'][$tpkey]->accuracy)?$input['tolerances'][$tpkey]->accuracy:'', array('class'=>'form-control accuracy_numeric','id'=>'accuracy','onkeypress'=>'return isNumberKey(event,this)')); ?>
                                    ...
                                    <section class="col-md-2">
                                        ...
                                        <?php echo Form::text('toleranceArray['.$tpkey.'][precision]',(isset($input['tolerances'][$tpkey])&&$input['tolerances'][$tpkey]->precision)?$input['tolerances'][$tpkey]->precision:'', array('class'=>'form-control precision_numeric','id'=>'precision','onkeypress'=>'return isNumberKey(event,this)')); ?>
                                    ...
                                    <section class="col-md-2">
                                        ...
                                        <?php echo Form::text('toleranceArray['.$tpkey.'][accuracyul]',(isset($input['tolerances'][$tpkey])&&$input['tolerances'][$tpkey]->accuracy_ul)?$input['tolerances'][$tpkey]->accuracy_ul:'', array('class'=>'form-control accuracy_ul_numeric','id'=>'accuracyul','onkeypress'=>'return isNumberKey(event,this)')); ?>
                                    ...
                                    <section class="col-md-2">
                                        ...
                                        <?php echo Form::text('toleranceArray['.$tpkey.'][precisionul]',(isset($input['tolerances'][$tpkey])&&$input['tolerances'][$tpkey]->precesion_ul)?$input['tolerances'][$tpkey]->precesion_ul:'', array('class'=>'form-control precesion_ul_numeric ','id'=>'precisionul','onkeypress'=>'return isNumberKey(event,this)')); ?>
                    ...
                    <div class="panel panel-default" style='text-align: center;'>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="text-center">
                                ...
                                <a href="<?php echo e(url('admin/isospecificationlist')); ?>" class="btn btn-space btn-default">Cancel</a>
                            </div>
        ...
        $('body').on('change', '#unit', function (event) {
            ...
            else
            {
                $.ajax({
                    ...
                    data: {
                        channel:channel,operation:operation,volume:volume,volumeRange:volumeRange,"_token": "<?php echo csrf_token(); ?>"
                    },
                    dataType: "json",
                    success: function (data) {
                        if (data) {
...
//         });
        ...
        $("form").submit(function(e){
            ...
            $.ajax({
                ...
                url: "<?php echo e(url("admin/checktolerancecombination")); ?>",
                data: {
                    channel:channel,operation:operation,volume:volume,volumeFrom:volumeFrom,volumeRange:volumeRange,id:id,"_token": "<?php echo csrf_token(); ?>"
                },
                dataType: "json",
                success: function (data) {
                    if (data) {
