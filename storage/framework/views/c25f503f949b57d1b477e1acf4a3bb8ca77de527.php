                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="m-t-18">
                                            ...
                                            <!--<?php echo Form::text('phoneNo',$input['phoneNo'], array( 'placeholder' => 'Enter the telephone number','data-parsley-type'=>"number",'class'=>'form-control phone','id'=>'phone','required'=>"required")); ?>-->
                                                <input data-parsley-type="number" type="text" name='phoneNo'
                                                       placeholder="Enter only numbers" required=""
                                                       class="form-control" value=<?php echo e($input['phoneNo']); ?>>
                                            </div>
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="m-t-20">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php echo Form::text('fax',$input['fax'], array( 'placeholder' => 'Enter the fax','class'=>'form-control')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php echo Form::text('email',$input['email'], array( 'placeholder' => 'Enter the email','class'=>'form-control','id'=>'email','required'=>"required")); ?>
