    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <div class="text-right div-rul">
                ...
                <a href="<?php echo e(url('admin/instrumentModelUploadPage')); ?>" class="btn btn-space btn-primary"><i class="fa fa-upload" aria-hidden="true"></i> Upload Instrument Model</a>
