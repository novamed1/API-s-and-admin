                            ...
                            <table cellspacing="0" cellpadding="0" width="100%">
                                ...
                                <?php endif; ?>
                                    ...
                                    <tr>
                                        <td colspan="9">
                                            <?php if($row['spares']): ?>
                                                <p> <span style="font-size: 12px;font-weight: 700">Maintenance And Spares </span>:  <?php echo e($row['spares']); ?></p>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="9" style="border-bottom:solid thin #000;">
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td><span style="font-size: 10px;font-weight: 700">Calibration Date</span><p><?php echo e($row['last_cal_date']); ?></p></td>
            ...
            <table cellspacing="0" cellpadding="0" width="100%" style="border-top: solid 2px #000;">
                <tr>
                    ...
                    <tr>
                        ...
                        <td width="40%" style="vertical-align:bottom;"><p
                                    style="width: 60%;padding:10px 3px 7px;border-bottom:solid thin #000;"><img src="<?php echo e(asset('users/signature/thumb/'.$admin_signature)); ?>"></p></td>
                        <td width="10%" style="padding:2px 5px;font-size:12px;font-weight:700;text-align: right;">Review
                            Date
                        </td>
                        <td width="40%" style="vertical-align:bottom;"><p
                                    style="width: 60%;padding:10px 3px 7px;border-bottom:solid thin #000;"><?php echo e(date('M/d/Y',strtotime(str_replace('-','/',$admin_date)))); ?></p>
                        </td>
                    </tr>
                <tr>
                    ...
                    <td width="40%" style="vertical-align:bottom;"><p
                                style="width: 60%;padding:10px 3px 7px;border-bottom:solid thin #000;"><img src="<?php echo e(asset('users/signature/thumb/'.$customer_signature)); ?>"></p></td>
                    <td width="10%" style="padding:2px 5px;font-size:12px;font-weight:700;text-align: right;">Review Date
                    </td>
                    <td width="40%" style="vertical-align:bottom;"><p
                                style="width: 60%;padding:10px 3px 7px;border-bottom:solid thin #000;"><?php echo e(date('M/d/Y')); ?></p></td>
                </tr>
            </table>
        </div>
    </div>
