    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <div class="text-right div-rul">
                <a href="<?php echo e(url('admin/serviceplan')); ?>" class="btn btn-space btn-primary">Add Service Plan</a>
            </div>
        </div>
        ...
        <script>
            $('#listTable tfoot th').each(function (index) {
                ...
                if (index != 2 && index != 3 && index != 4 && index != 5 && index != 6) {
                    ...
                    $(this).html('<?php echo Form::select("asfounds",$asFound,'',array('class'=>'')); ?>');
                }else if(index == 3){
                    $(this).html('<?php echo Form::select("ascalibrates",$asCalibrate,'',array('class'=>'')); ?>');
            ...
            $('#listTable').DataTable({
                "bServerSide": true,
                "sAjaxSource": "<?php echo e(url('admin/servicelistdata')); ?>",
                "sServerMethod": "POST",
                "iDisplayLength": 10,
                "searching": true,
        ...
        <script type="text/javascript">
            ...
            $('body').on('click', '#view', function () {
                ...
                $.ajax({
                    type: "GET",
                    url: '<?php echo e(url("admin/viewServicePlan")); ?>',
                    data: {
