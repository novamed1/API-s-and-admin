    ...
    <div class="am-content">
        <div class="page-head">
            <h2>Order Details (Number :<span></span> <?php echo e($order->order_number); ?>) Total Amount : <i class="fa fa-dollar"
                                                                                                 aria-hidden="true"></i> <?php echo e($order->order_amt); ?>
                                        ...
                                        <div class="">
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <address>
                                                            ...
                                                            <br><span
                                                                    id="changedCustomerCity"><?php echo e($customer->city); ?></span><br>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <address>
                                                            ...
                                                            <br><span
                                                                    id="billing_city"><?php echo e($billing->city); ?></span><br>
                                                            <abbr title="Phone">Contact: </abbr><span
                                            ...
                                            <div class="col-md-3">
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <address>
                                                            <strong><?php echo e($contact->contact_name); ?>

                                                                <br>
                                                            </strong><?php echo e($contact->address1); ?>

                                                            <br><?php echo e($contact->city); ?>

                                                            <br>Contact: <?php echo e($contact->phone_no); ?>

                                                        </address>
                                                        <address><strong>Email Id <br></strong><a
                                                                    mailto:#><?php echo e($contact->email_id); ?></a>
                                                        </address>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="sms-table-list" id="pageResult">
                                                    <div class="table-responsive noSwipe">
                                                        <table class="table table-fw-widget table-hover"
                                                            ...
                                                            <?php $__currentLoopData = $orderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>

                                                                <tr>
                                                                    <td><?php echo e($value->model_name); ?></td>
                                                                    <td><?php echo e($value->asset_no); ?></td>
                                                                    <td><?php echo e($value->serial_no); ?></td>
                                                                    <td><i class="fa fa-dollar"
                                                                           aria-hidden="true"></i><?php echo e($value->order_item_amt+$value->subtotal); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Total</td>
                                                                <td><i class="fa fa-dollar"
                                                                       aria-hidden="true"></i><?php echo e($totalAmount); ?></td>
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="text-center download">
                                                            <?php if($orderDetails->po_document): ?>
                                                                <a download="<?php echo e($orderDetails->po_document); ?>"
                                                                   href="<?php echo e('http://' . $_SERVER['SERVER_NAME'] . '/public/purchaseorder/customerdocuments/'. $orderDetails->po_document); ?>"
                                                                   class="dload">
