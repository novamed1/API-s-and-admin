    ...
    <div class="am-content">
        <div class="page-head">
            ...
            <div class="text-right div-rul">
                <a href="<?php echo e(url('admin/adddevice')); ?>" class="btn btn-space btn-primary">Add Standard Equipment Details</a>
            </div>
        </div>
        ...
        <script>
            ...
            $('#listTable').DataTable({
                "bServerSide": true,
                "sAjaxSource": "<?php echo e(url('admin/devicelistdata')); ?>",
                "sServerMethod": "POST",
                "iDisplayLength": 10,
                "searching": true,
        ...
        <script>
            $('body').on('click', '#changeTechnician', function () {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(url("admin/checkTechnicianforDevice")); ?>",
                    dataType: "JSON",
        ...
        <script>
            $('body').on('click', '#submitTech', function () {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(url("admin/assignTechnicianforModel")); ?>",
                    dataType: "JSON",
                    success: function (json) {
