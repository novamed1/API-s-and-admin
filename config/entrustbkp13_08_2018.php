...
return [
    ...
    */
    ...
    |
    */
    'role_foreign_key' => 'user_group_id',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |
    */
    'role_user_table' => 'tbl_group_user',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |
    */
    'permissions_table' => 'tbl_permissions',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'permission_role_table' => 'tbl_permission_group',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'permission_foreign_key' => 'permissions_id',
];